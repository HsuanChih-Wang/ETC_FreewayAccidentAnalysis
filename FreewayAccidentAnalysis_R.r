freeway_no1_north <-read.csv("C:/Users/WangRabbit/Documents/GitHub/FreewayAccidentAnalysis/data/freeway_no1_north.csv", sep=",")
...
freeway_logistic <- glm(formula = crash ~ lane + minlane + addlane + totalwidth + inshoulder + outshoulder + shouderoallow + upslopelength 
